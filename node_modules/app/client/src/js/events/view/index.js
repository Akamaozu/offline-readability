                ...
                return function( data ){
                  ...
                  noticeboard.once('teardown-view', 'render-next-view', function(){
                    ...
                    ReactDOM.render( index_layout, document.getElementById('main-wrapper'), function(){
                      ...
                      require('jquery')( document ).scrollTop( 0 );
          ...
          var get_article = {};
              ...
              get_article.callback = function(){
                ...
                return function( data ){
                  ...
                  noticeboard.notify('get-articles-bookmark-hash', {

                    callback: function( hash ){

                      noticeboard.notify('get-bookmarks-page', {

                        type: hash[ get_article.id ].type,
                        page: hash[ get_article.id ].page,
                        ...
                        callback: function( page ){
                          ...
                          var React = require('react'),
                              ...
                              bookmark = page.bookmarks[ hash[ get_article.id ].index ],
