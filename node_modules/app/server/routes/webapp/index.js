...
// routes
  ...
  // bookmarks
    webapp_routes.get('/bookmarks', function( req, res ){
      ...
      readability.bookmarks( req.session.auth.oauth_token, req.session.auth.oauth_token_secret, {}, function( error, bookmarks ){

        var content = ( error ? error : bookmarks );

        console.log( bookmarks );

        res.render( path_to_client_dir + '/index.ejs', { react_server_render: content.toString() });
      });
    });